...
<table cellpadding='5' cellspacing='5' width='500' align='center'>
	...
	<tr align="center"><td colspan="2"  align="right"></td><td align="left"><input type="button" value="ตกลง" onclick="goto_url(1)">&nbsp;&nbsp;<INPUT TYPE="button" name="back" value="ย้อนกลับ" onclick="goto_url(0)" ></td></tr>
	<tr><td colspan=3 height=10></td></tr>
</table>
</form>	
