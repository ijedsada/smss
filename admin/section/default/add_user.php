...
$sql = "select system_user.id, system_user.username, system_user.userpass, system_user.smss_admin, system_user.status, person_main.name, person_main.surname, person_main.person_id from system_user left join person_main on system_user.person_id=person_main.person_id order by person_main.name limit $start,$pagelen";
}

$dbquery = mysqli_query($connect,$sql);
echo  "<table width='75%' border='1' align='center' style='border-collapse: collapse'>";
echo "<Tr bgcolor='#E6E6E6'><Td  align='center' width='50'>ที่</Td><Td align='center'>Username</Td><Td  align='center'>ชื่อ-สกุล</Td><Td align='center' width='170'>สถานะผู้ดูแลระบบ(Admin)</Td><Td align='center' width='100'>สถานะใช้งาน</Td><Td align='center' width='50'>ลบ</Td><Td align='center' width='50'>แก้ไข</Td></Tr>";
...
echo "<tr><td><b>กรณีผู้ใช้ลืมรหัสผ่าน</b>  ให้ลบผู้ใช้ออก แล้วจึงให้ login ด้วยเลขประจำตัวประชาชน</td></tr>";
echo "</Table>";
}
