...
//ส่วนบันทึกข้อมูล
if($index==4){
$sql = "insert into system_workgroup (workgroup, workgroup_desc,workgroup_order) values ('$_POST[workgroup]', '$_POST[workgroup_desc]','1')";
$dbquery = mysqli_query($connect,$sql);
}
...
if(isset($_REQUEST['page']))
	...
	echo "<Tr><Td align='left'><INPUT TYPE='button' name='smb' value='เพิ่มกลุ่ม(งาน)' onclick='location.href=\"?file=workgroup&index=1\"'</Td></Tr>";
	echo "</Table>";
	echo  "<table width='60%' border='1' align='center' style='border-collapse: collapse'>";
	echo "<Tr bgcolor='#E6E6E6'><Td  align='center' width='50'>ที่</Td><Td  align='center' width='100'>รหัสกลุ่ม(งาน)</Td><Td  align='center'>ชื่อกลุ่ม(งาน)</Td><Td align='center' width='50'>ลำดับ</Td><Td align='center' width='50'>ลบ</Td><Td align='center' width='50'>แก้ไข</Td></Tr>";
